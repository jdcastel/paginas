...
const Login = () => {
  ...
  return (
    <Grid
      ...
      alignItems="center"
      sx={{ backgroundColor: "grey", flexGrow: 1, minHeight: "100vh" }}
    >
      <Grid item sm={12}>
        <Grid
          container
        ...
        >
          ...
          >
            ...
            <Typography>Enter your credential to continue</Typography>
            ...
            <Grid container sx={{ mb: 3 }}>
              ...
              <Grid item sm="6">
                <Typography fontSize="0.8rem">Forgot My password</Typography>
              </Grid>
            </Grid>
            <Button
            ...
            <Divider />
            <Button variant="subtitle1">Don't have an account?</Button>
          </Grid>
        </Grid>
      </Grid>
    </Grid>
